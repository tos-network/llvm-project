; RUN: llc -tbf-enable-btf-emission -march=tbf -mcpu=tbfv2 -filetype=obj < %s | llvm-objdump -r - | FileCheck --check-prefix=CHECK-RELOC %s
...
; CHECK-RELOC: R_TBF_64_NODYLD32 s
; CHECK-RELOC: R_TBF_64_NODYLD32 g
