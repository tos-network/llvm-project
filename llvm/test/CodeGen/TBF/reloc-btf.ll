; RUN: llc -tbf-enable-btf-emission -march=tbf -mcpu=v3 -filetype=obj < %s | llvm-objdump -r - | FileCheck --check-prefix=CHECK-RELOC %s
...
; CHECK-RELOC: file format elf64-tbf
; CHECK-RELOC: RELOCATION RECORDS FOR [.debug_info]:
; CHECK-RELOC: R_TBF_64_ABS32 .debug_abbrev
; CHECK-RELOC: R_TBF_64_ABS64
; CHECK-RELOC: RELOCATION RECORDS FOR [.BTF.ext]:
; CHECK-RELOC: R_TBF_64_NODYLD32
