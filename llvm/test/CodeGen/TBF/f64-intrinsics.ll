; RUN: llc -march=tbf -mattr=+alu32 < %s | FileCheck -check-prefix=CHECK32 %s
; RUN: llc -march=tbf < %s | FileCheck -check-prefix=CHECK64 %s

; TODO: Add much more coverage. Currently this a sign extension regression
; test (TBFTargetLowering::shouldSignExtendTypeInLibCall).
