; RUN: llc -tbf-enable-btf-emission -march=tbf -filetype=asm -o - %s | FileCheck -check-prefixes=CHECK %s
; Note that llvm.bpd.load does not apply to TBF, delete eventually.
: XFAIL: *
; Source code:
