; RUN: llc < %s -march=tbf -verify-machineinstrs | FileCheck %s
; RUN: llc < %s -mtriple=tbf-tos-tos -verify-machineinstrs | FileCheck %s
; RUN: llc < %s -mtriple=tbpfv0-tos-tos -verify-machineinstrs | FileCheck %s
