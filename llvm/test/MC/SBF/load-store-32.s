...
// CHECK: 71 05 00 00 00 00 00 00 	r5 = *(u8 *)(r0 + 0x0)
// CHECK: 69 16 08 00 00 00 00 00 	r6 = *(u16 *)(r1 + 0x8)
// CHECK: 61 27 10 00 00 00 00 00 	r7 = *(u32 *)(r2 + 0x10)
...
// CHECK: 73 70 00 00 00 00 00 00 	*(u8 *)(r0 + 0x0) = r7
// CHECK: 6b 81 08 00 00 00 00 00 	*(u16 *)(r1 + 0x8) = r8
// CHECK: 63 92 10 00 00 00 00 00 	*(u32 *)(r2 + 0x10) = r9
// CHECK: c3 92 10 00 00 00 00 00 	lock *(u32 *)(r2 + 0x10) += r9
